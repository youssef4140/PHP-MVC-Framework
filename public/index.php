...
<body>
    ...
    <section class="home" id="home">
        <div class="image" data-aos="fade-right">
            <img src="https://picsum.photos/400/600" alt="me">
        </div>
        <div class="content" >
            <h3 data-aos="fade-up">Name is Metwally, Youssef Metwally.</h3>
    ...
    <section class="about" id="about">
        ...
        <div class="biography" >
            ...
            <div class="bio">
                <h3 data-aos="zoom-in"><span>name: </span>Youssef Metwally</h3>
                <h3 data-aos="zoom-in"><span>email: </span>Youssef@example.com</h3>
                <h3 data-aos="zoom-in"><span>address: </span>Around, earth</h3>
                <h3 data-aos="zoom-in"><span>phone: </span>+424-242-4242</h3>
                <h3 data-aos="zoom-in"><span>age: </span>timeless</h3>
                <h3 data-aos="zoom-in"><span>experience: </span>none</h3>
            </div>
